...
public class Level4 extends LevelState{
    ...
    public Level4(GameStateManager gsm) {
        ...
        background = new Texture("texture2-2.png");
    ...
    public void update(float dt) {
        ...
        for(int i = 0; i < tubes.size; i++){
            ...
            if (i % 2 == 0){
                ...
                if (tubeLimiter){
                    tube.setPosBotTube((float) (tube.getPosBotTube().y + 1));
                    tube.setPosTopTube((float) (tube.getPosTopTube().y + 1));
                }
                else{
                    tube.setPosBotTube((float) (tube.getPosBotTube().y - 1));
                    tube.setPosTopTube((float) (tube.getPosTopTube().y - 1));
        ...
        if(levelCompleted){
            gsm.set(new VictoryState(gsm, "texture2-2.png"));
        }
