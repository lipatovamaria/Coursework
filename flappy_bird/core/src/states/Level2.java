...
public class Level2 extends LevelState{
    ...
    public Level2(GameStateManager gsm) {
        super(gsm);
        bird = new PlayerBird(100,250, 70);
        background = new Texture("texture7.png");
    ...
    public void update(float dt) {
        ...
        if(levelCompleted){
            gsm.set(new VictoryState(gsm, "texture7.png"));
        }
    ...
    public void render(SpriteBatch batch) {
        ...
        for(int i = 0; i < hpBooster.size; i++){
            batch.draw(hpBooster.get(i).getTexture(), hpBooster.get(i).getPosHPBooster().x,hpBooster.get(i).getHpBoosterRec().y);
        }
